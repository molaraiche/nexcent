  ...
  return (
    <section className='flex lg:flex-row md:flex-col sm:flex-col xsm:flex-col lg:gap-[20rem] md:gap-20 sm:gap-20 xsm:gap-20 items-center  py-24'>
      <div className='lg:w-1/2 '>
        <h1 className='lg:text-[64px] md:text-5xl sm:text-4xl xsm:text-3xl font-semibold leading-[76px]'>
        ...
        <div className='mt-8'>
          <Button className='bg-primary text-neutral-white rounded-[4px] py-3.5 px-8'>
            Register
          </Button>
        </div>
      </div>
